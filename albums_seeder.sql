...
VALUES('Michael Jackson','Thriller',1982,47.3,'Pop'),
    ('Eagles','Their Greatest Hits(1971-1975)',1976,41.2,'Country'),
    ...
    ('Fleetwood Mac', 'Rumours', 1977, 27.9, 'Country'),
    ('Shania Twain', 'Come On Over', 1997, 29.6, 'Country'),
    ('Various Artists', 'Grease: The Original Soundtrack from the Motion Picture', 1978, 14.4, 'sound track'),
